defmodule WeChat.UtilsTest do
  ...
  test "parse_uri" do
    ...
    assert uri.scheme == "https" and uri.port == 443 and uri.host == "api.weixin.qq.com" and uri.path == "/cgi-bin/user/info/batchget"

    uri = Utils.parse_uri("//cgi-bin/user/info/batchget")
    assert uri.scheme == "https" and uri.port == 443 and uri.host == "cgi-bin" and uri.path == "/user/info/batchget"

    uri = Utils.parse_uri("cgi-bin/user/info/batchget")
    assert uri.scheme == "https" and uri.port == 443 and uri.host == "api.weixin.qq.com" and uri.path == "cgi-bin/user/info/batchget"

    uri = Utils.parse_uri("/a/b", host: "test.api.weixin.qq.com", port: 443)
    assert uri.scheme == "https" and uri.port == 443 and uri.host == "test.api.weixin.qq.com" and uri.path == "/a/b"

    uri = Utils.parse_uri("/a/b?arg1=1")
    assert uri.path == "/a/b" and uri.query == "arg1=1"

    uri = Utils.parse_uri("/a/b?arg1=1", port: 80, scheme: "http")
    assert uri.path == "/a/b" and uri.query == "arg1=1" and uri.port == 80 and uri.scheme == "http"
